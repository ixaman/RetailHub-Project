...
from apps.models import Categories,SubCategories,CustomUser,MerchantUser,Products,ProductAbout,ProductDetails,ProductMedia,ProductTransaction,ProductTags
...
from retailhub.settings import BASE_URL
...
class ProductMediaDelete(View):
    def get(self,request,*args,**kwargs):
        ...
        import os
        from retailhub import settings
